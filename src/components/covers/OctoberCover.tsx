    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 z-10 select-none pointer-events-none">
          ...
          <div
            className="absolute bottom-0 left-0 right-0 h-[2.5px] z-6 overflow-hidden bg-[repeating-linear-gradient(90deg,#f2c94c_0_24px,transparent_24px_38px)] shadow-[0_-1px_4px_rgba(0,0,0,0.5)]"
            style={{ opacity: mapRange(p, 0.25, 0.70, 1.0, 0.0) }}
          >
            <div
              className={`absolute inset-0 bg-[linear-gradient(90deg,transparent_30%,rgba(255,250,235,0.8)_50%,transparent_70%)] -translate-x-full animate-shimmer ${
